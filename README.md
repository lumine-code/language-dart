...
- **Grammars**: provides Tree-sitter grammars, built from [tree-sitter-dart](https://github.com/UserNobody14/tree-sitter-dart).
- **Syntax highlighting**: full tree-sitter grammar coverage for Dart files.
